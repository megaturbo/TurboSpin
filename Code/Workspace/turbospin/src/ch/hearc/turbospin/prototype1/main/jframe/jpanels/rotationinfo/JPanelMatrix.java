...
public class JPanelMatrix extends JPanel
	...
	protected void paintComponent(Graphics g)
		...
		g2d.drawString("Rotated by: " + String.format("%.3f", alpha) + Hexacodes.PI_LOWER, offset + 30 + 210, 190);
		...
		g2d.drawString("Rotated by: " + String.format("%.3f", beta) + Hexacodes.PI_LOWER, offset + 30 + 210 + 195, 190);

		g2d.setColor(Color.RED);
		drawRotationMatrix(g2d, matrixRx, offset + 210 + 195 + 195, 60);
		g2d.drawString("Rotation around X axis", offset + 20 + 210 + 195 + 195, 50);
		g2d.drawString("Rotated by: " + String.format("%.3f", gamma) + Hexacodes.PI_LOWER, offset + 30 + 210 + 2 * 195, 190);
